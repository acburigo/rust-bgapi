...
impl ToBytes for MessagePayload {
    fn to_bytes(&self) -> Vec<u8> {
        ...
        match self {
            // coex
            cmd_coex_get_counters(x) => x.to_bytes(),
            rsp_coex_get_counters(x) => x.to_bytes(),
            cmd_coex_set_options(x) => x.to_bytes(),
            rsp_coex_set_options(x) => x.to_bytes(),

            // dfu
            cmd_dfu_flash_set_address(x) => x.to_bytes(),
            rsp_dfu_flash_set_address(x) => x.to_bytes(),
            cmd_dfu_flash_upload(x) => x.to_bytes(),
            rsp_dfu_flash_upload(x) => x.to_bytes(),
            cmd_dfu_flash_upload_finish(x) => x.to_bytes(),
            rsp_dfu_flash_upload_finish(x) => x.to_bytes(),
            cmd_dfu_reset(x) => x.to_bytes(),
            evt_dfu_boot(x) => x.to_bytes(),
            evt_dfu_boot_failure(x) => x.to_bytes(),

            // flash
            cmd_flash_ps_erase(x) => x.to_bytes(),
            rsp_flash_ps_erase(x) => x.to_bytes(),
            cmd_flash_ps_erase_all(x) => x.to_bytes(),
            rsp_flash_ps_erase_all(x) => x.to_bytes(),
            cmd_flash_ps_load(x) => x.to_bytes(),
            rsp_flash_ps_load(x) => x.to_bytes(),
            cmd_flash_ps_save(x) => x.to_bytes(),
            rsp_flash_ps_save(x) => x.to_bytes(),

            // gatt
            cmd_gatt_discover_characteristics(x) => x.to_bytes(),
            rsp_gatt_discover_characteristics(x) => x.to_bytes(),
            cmd_gatt_discover_characteristics_by_uuid(x) => x.to_bytes(),
            rsp_gatt_discover_characteristics_by_uuid(x) => x.to_bytes(),
            cmd_gatt_discover_descriptors(x) => x.to_bytes(),
            rsp_gatt_discover_descriptors(x) => x.to_bytes(),
            cmd_gatt_discover_primary_services(x) => x.to_bytes(),
            rsp_gatt_discover_primary_services(x) => x.to_bytes(),
            cmd_gatt_discover_primary_services_by_uuid(x) => x.to_bytes(),
            rsp_gatt_discover_primary_services_by_uuid(x) => x.to_bytes(),
            cmd_gatt_execute_characteristic_value_write(x) => x.to_bytes(),
            rsp_gatt_execute_characteristic_value_write(x) => x.to_bytes(),
            cmd_gatt_find_included_services(x) => x.to_bytes(),
            rsp_gatt_find_included_services(x) => x.to_bytes(),
            cmd_gatt_prepare_characteristic_value_reliable_write(x) => x.to_bytes(),
            rsp_gatt_prepare_characteristic_value_reliable_write(x) => x.to_bytes(),
            cmd_gatt_prepare_characteristic_value_write(x) => x.to_bytes(),
            rsp_gatt_prepare_characteristic_value_write(x) => x.to_bytes(),
            cmd_gatt_read_characteristic_value(x) => x.to_bytes(),
            rsp_gatt_read_characteristic_value(x) => x.to_bytes(),
            cmd_gatt_read_characteristic_value_by_uuid(x) => x.to_bytes(),
            rsp_gatt_read_characteristic_value_by_uuid(x) => x.to_bytes(),
            cmd_gatt_read_characteristic_value_from_offset(x) => x.to_bytes(),
            rsp_gatt_read_characteristic_value_from_offset(x) => x.to_bytes(),
            cmd_gatt_read_descriptor_value(x) => x.to_bytes(),
            rsp_gatt_read_descriptor_value(x) => x.to_bytes(),
            cmd_gatt_read_multiple_characteristic_values(x) => x.to_bytes(),
            rsp_gatt_read_multiple_characteristic_values(x) => x.to_bytes(),
            cmd_gatt_send_characteristic_confirmation(x) => x.to_bytes(),
            rsp_gatt_send_characteristic_confirmation(x) => x.to_bytes(),
            cmd_gatt_set_characteristic_notification(x) => x.to_bytes(),
            rsp_gatt_set_characteristic_notification(x) => x.to_bytes(),
            cmd_gatt_set_max_mtu(x) => x.to_bytes(),
            rsp_gatt_set_max_mtu(x) => x.to_bytes(),
            cmd_gatt_write_characteristic_value(x) => x.to_bytes(),
            rsp_gatt_write_characteristic_value(x) => x.to_bytes(),
            cmd_gatt_write_characteristic_value_without_response(x) => x.to_bytes(),
            rsp_gatt_write_characteristic_value_without_response(x) => x.to_bytes(),
            cmd_gatt_write_descriptor_value(x) => x.to_bytes(),
            rsp_gatt_write_descriptor_value(x) => x.to_bytes(),
            evt_gatt_characteristic(x) => x.to_bytes(),
            evt_gatt_characteristic_value(x) => x.to_bytes(),
            evt_gatt_descriptor(x) => x.to_bytes(),
            evt_gatt_descriptor_value(x) => x.to_bytes(),
            evt_gatt_mtu_exchanged(x) => x.to_bytes(),
            evt_gatt_procedure_completed(x) => x.to_bytes(),
            evt_gatt_service(x) => x.to_bytes(),

            // gatt_server
            cmd_gatt_server_find_attribute(x) => x.to_bytes(),
            rsp_gatt_server_find_attribute(x) => x.to_bytes(),
            cmd_gatt_server_read_attribute_type(x) => x.to_bytes(),
            rsp_gatt_server_read_attribute_type(x) => x.to_bytes(),
            cmd_gatt_server_read_attribute_value(x) => x.to_bytes(),
            rsp_gatt_server_read_attribute_value(x) => x.to_bytes(),
            cmd_gatt_server_send_characteristic_notification(x) => x.to_bytes(),
            rsp_gatt_server_send_characteristic_notification(x) => x.to_bytes(),
            cmd_gatt_server_send_user_read_response(x) => x.to_bytes(),
            rsp_gatt_server_send_user_read_response(x) => x.to_bytes(),
            cmd_gatt_server_send_user_write_response(x) => x.to_bytes(),
            rsp_gatt_server_send_user_write_response(x) => x.to_bytes(),
            cmd_gatt_server_set_capabilities(x) => x.to_bytes(),
            rsp_gatt_server_set_capabilities(x) => x.to_bytes(),
            cmd_gatt_server_write_attribute_value(x) => x.to_bytes(),
            rsp_gatt_server_write_attribute_value(x) => x.to_bytes(),
            evt_gatt_server_attribute_value(x) => x.to_bytes(),
            evt_gatt_server_characteristic_status(x) => x.to_bytes(),
            evt_gatt_server_execute_write_completed(x) => x.to_bytes(),
            evt_gatt_server_user_read_request(x) => x.to_bytes(),
            evt_gatt_server_user_write_request(x) => x.to_bytes(),

            // hardware
            cmd_hardware_set_lazy_soft_timer(x) => x.to_bytes(),
            rsp_hardware_set_lazy_soft_timer(x) => x.to_bytes(),
            cmd_hardware_set_soft_timer(x) => x.to_bytes(),
            rsp_hardware_set_soft_timer(x) => x.to_bytes(),
            evt_hardware_soft_timer(x) => x.to_bytes(),

            // le_connection
            cmd_le_connection_close(x) => x.to_bytes(),
            rsp_le_connection_close(x) => x.to_bytes(),
            cmd_le_connection_disable_slave_latency(x) => x.to_bytes(),
            rsp_le_connection_disable_slave_latency(x) => x.to_bytes(),
            cmd_le_connection_get_rssi(x) => x.to_bytes(),
            rsp_le_connection_get_rssi(x) => x.to_bytes(),
            cmd_le_connection_set_parameters(x) => x.to_bytes(),
            rsp_le_connection_set_parameters(x) => x.to_bytes(),
            cmd_le_connection_set_phy(x) => x.to_bytes(),
            rsp_le_connection_set_phy(x) => x.to_bytes(),
            evt_le_connection_closed(x) => x.to_bytes(),
            evt_le_connection_opened(x) => x.to_bytes(),
            evt_le_connection_parameters(x) => x.to_bytes(),
            evt_le_connection_phy_status(x) => x.to_bytes(),
            evt_le_connection_rssi(x) => x.to_bytes(),

            // le_gap
            cmd_le_gap_bt5_set_adv_data(x) => x.to_bytes(),
            rsp_le_gap_bt5_set_adv_data(x) => x.to_bytes(),
            cmd_le_gap_clear_advertise_configuration(x) => x.to_bytes(),
            rsp_le_gap_clear_advertise_configuration(x) => x.to_bytes(),
            cmd_le_gap_connect(x) => x.to_bytes(),
            rsp_le_gap_connect(x) => x.to_bytes(),
            cmd_le_gap_end_procedure(x) => x.to_bytes(),
            rsp_le_gap_end_procedure(x) => x.to_bytes(),
            cmd_le_gap_set_advertise_channel_map(x) => x.to_bytes(),
            rsp_le_gap_set_advertise_channel_map(x) => x.to_bytes(),
            cmd_le_gap_set_advertise_configuration(x) => x.to_bytes(),
            rsp_le_gap_set_advertise_configuration(x) => x.to_bytes(),
            cmd_le_gap_set_advertise_phy(x) => x.to_bytes(),
            rsp_le_gap_set_advertise_phy(x) => x.to_bytes(),
            cmd_le_gap_set_advertise_report_scan_request(x) => x.to_bytes(),
            rsp_le_gap_set_advertise_report_scan_request(x) => x.to_bytes(),
            cmd_le_gap_set_advertise_timing(x) => x.to_bytes(),
            rsp_le_gap_set_advertise_timing(x) => x.to_bytes(),
            cmd_le_gap_set_advertise_tx_power(x) => x.to_bytes(),
            rsp_le_gap_set_advertise_tx_power(x) => x.to_bytes(),
            cmd_le_gap_set_conn_parameters(x) => x.to_bytes(),
            rsp_le_gap_set_conn_parameters(x) => x.to_bytes(),
            cmd_le_gap_set_data_channel_classification(x) => x.to_bytes(),
            rsp_le_gap_set_data_channel_classification(x) => x.to_bytes(),
            cmd_le_gap_set_discovery_timing(x) => x.to_bytes(),
            rsp_le_gap_set_discovery_timing(x) => x.to_bytes(),
            cmd_le_gap_set_discovery_type(x) => x.to_bytes(),
            rsp_le_gap_set_discovery_type(x) => x.to_bytes(),
            cmd_le_gap_set_privacy_mode(x) => x.to_bytes(),
            rsp_le_gap_set_privacy_mode(x) => x.to_bytes(),
            cmd_le_gap_start_advertising(x) => x.to_bytes(),
            rsp_le_gap_start_advertising(x) => x.to_bytes(),
            cmd_le_gap_start_discovery(x) => x.to_bytes(),
            rsp_le_gap_start_discovery(x) => x.to_bytes(),
            cmd_le_gap_stop_advertising(x) => x.to_bytes(),
            rsp_le_gap_stop_advertising(x) => x.to_bytes(),
            evt_le_gap_adv_timeout(x) => x.to_bytes(),
            evt_le_gap_scan_request(x) => x.to_bytes(),
            evt_le_gap_scan_response(x) => x.to_bytes(),

            // sm
            cmd_sm_bonding_confirm(x) => x.to_bytes(),
            rsp_sm_bonding_confirm(x) => x.to_bytes(),
            cmd_sm_configure(x) => x.to_bytes(),
            rsp_sm_configure(x) => x.to_bytes(),
            cmd_sm_delete_bonding(x) => x.to_bytes(),
            rsp_sm_delete_bonding(x) => x.to_bytes(),
            cmd_sm_delete_bondings(x) => x.to_bytes(),
            rsp_sm_delete_bondings(x) => x.to_bytes(),
            cmd_sm_enter_passkey(x) => x.to_bytes(),
            rsp_sm_enter_passkey(x) => x.to_bytes(),
            cmd_sm_increase_security(x) => x.to_bytes(),
            rsp_sm_increase_security(x) => x.to_bytes(),
            cmd_sm_list_all_bondings(x) => x.to_bytes(),
            rsp_sm_list_all_bondings(x) => x.to_bytes(),
            cmd_sm_passkey_confirm(x) => x.to_bytes(),
            rsp_sm_passkey_confirm(x) => x.to_bytes(),
            cmd_sm_set_bondable_mode(x) => x.to_bytes(),
            rsp_sm_set_bondable_mode(x) => x.to_bytes(),
            cmd_sm_set_debug_mode(x) => x.to_bytes(),
            rsp_sm_set_debug_mode(x) => x.to_bytes(),
            cmd_sm_set_oob_data(x) => x.to_bytes(),
            rsp_sm_set_oob_data(x) => x.to_bytes(),
            cmd_sm_set_passkey(x) => x.to_bytes(),
            rsp_sm_set_passkey(x) => x.to_bytes(),
            cmd_sm_set_sc_remote_oob_data(x) => x.to_bytes(),
            rsp_sm_set_sc_remote_oob_data(x) => x.to_bytes(),
            cmd_sm_store_bonding_configuration(x) => x.to_bytes(),
            rsp_sm_store_bonding_configuration(x) => x.to_bytes(),
            cmd_sm_use_sc_oob(x) => x.to_bytes(),
            rsp_sm_use_sc_oob(x) => x.to_bytes(),
            evt_sm_bonded(x) => x.to_bytes(),
            evt_sm_bonding_failed(x) => x.to_bytes(),
            evt_sm_confirm_bonding(x) => x.to_bytes(),
            evt_sm_confirm_passkey(x) => x.to_bytes(),
            evt_sm_list_all_bondings_complete(x) => x.to_bytes(),
            evt_sm_list_bonding_entry(x) => x.to_bytes(),
            evt_sm_passkey_display(x) => x.to_bytes(),
            evt_sm_passkey_request(x) => x.to_bytes(),

            // system
            cmd_system_get_bt_address(x) => x.to_bytes(),
            rsp_system_get_bt_address(x) => x.to_bytes(),
            cmd_system_get_counters(x) => x.to_bytes(),
            rsp_system_get_counters(x) => x.to_bytes(),
            cmd_system_get_random_data(x) => x.to_bytes(),
            rsp_system_get_random_data(x) => x.to_bytes(),
            cmd_system_halt(x) => x.to_bytes(),
            rsp_system_halt(x) => x.to_bytes(),
            cmd_system_hello(x) => x.to_bytes(),
            rsp_system_hello(x) => x.to_bytes(),
            cmd_system_reset(x) => x.to_bytes(),
            cmd_system_set_bt_address(x) => x.to_bytes(),
            rsp_system_set_bt_address(x) => x.to_bytes(),
            cmd_system_set_device_name(x) => x.to_bytes(),
            rsp_system_set_device_name(x) => x.to_bytes(),
            cmd_system_set_tx_power(x) => x.to_bytes(),
            rsp_system_set_tx_power(x) => x.to_bytes(),
            evt_system_awake(x) => x.to_bytes(),
            evt_system_boot(x) => x.to_bytes(),
            evt_system_error(x) => x.to_bytes(),
            evt_system_external_signal(x) => x.to_bytes(),
            evt_system_hardware_error(x) => x.to_bytes(),

            // test
            cmd_test_dtm_end(x) => x.to_bytes(),
            rsp_test_dtm_end(x) => x.to_bytes(),
            cmd_test_dtm_rx(x) => x.to_bytes(),
            rsp_test_dtm_rx(x) => x.to_bytes(),
            cmd_test_dtm_tx(x) => x.to_bytes(),
            rsp_test_dtm_tx(x) => x.to_bytes(),
            evt_test_dtm_completed(x) => x.to_bytes(),

            // user
            cmd_user_message_to_target(x) => x.to_bytes(),
            rsp_user_message_to_target(x) => x.to_bytes(),
            evt_user_message_to_host(x) => x.to_bytes(),
        }
    }
}
